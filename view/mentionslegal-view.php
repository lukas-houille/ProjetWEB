...
<main>
    ...
    <p>Le traitement de vos données à caractère personnel est régi par notre Charte de protection des données personnelles, disponible depuis la section "Protection des données personnelles", conformément au Règlement Général sur la Protection des Données 2016/679 du 27 avril 2016 (« RGPD »)<a class="lienhebergeur" href="rgpd.php">RGPD<a></p>

    <h2>Conditions d'utilisation</h2>
    <p>En utilisant notre site, vous acceptez nos conditions d'utilisation, disponibles depuis la section "Conditions d'utilisation".</p>
